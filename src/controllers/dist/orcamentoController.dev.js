...
exports.generatePDF = function _callee(req, res) {
  var _req$body, nomeCliente, telefoneContato, pacoteViagem, localSaida, dataSaida, horaSaida, dataRetorno, horaRetorno, valorComDespesa, valorSemDespesa, valorComNota, modeloVan, cortesiaKm, valorAcrescimoKm, dataGeracao, pdfBuffer, allowedOrigins, origin;
  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, nomeCliente = _req$body.nomeCliente, telefoneContato = _req$body.telefoneContato, pacoteViagem = _req$body.pacoteViagem, localSaida = _req$body.localSaida, dataSaida = _req$body.dataSaida, horaSaida = _req$body.horaSaida, dataRetorno = _req$body.dataRetorno, horaRetorno = _req$body.horaRetorno, valorComDespesa = _req$body.valorComDespesa, valorSemDespesa = _req$body.valorSemDespesa, valorComNota = _req$body.valorComNota, modeloVan = _req$body.modeloVan, cortesiaKm = _req$body.cortesiaKm, valorAcrescimoKm = _req$body.valorAcrescimoKm;
          dataGeracao = getDateFormated();
          _context.next = 5;
          return regeneratorRuntime.awrap(pdfOrcamentoService.createPDF(nomeCliente, telefoneContato, pacoteViagem, localSaida, dataSaida, horaSaida, dataRetorno, horaRetorno, valorComDespesa, valorSemDespesa, valorComNota, modeloVan, cortesiaKm, valorAcrescimoKm, dataGeracao));
