    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          emailService.enviarDocumentoGerado(pdfBuffer, 'c.danilo.f.silva@gmail.com', 'Backup de documento gerado', "Or\xE7amento_".concat(dataAtual)); // Envia o PDF para o cliente (frontend)
