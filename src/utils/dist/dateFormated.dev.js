...
function getDataArquivo() {
  ...
  var _dataStr$split$0$spli3 = dataStr.split(' ')[0].split('/'),
      _dataStr$split$0$spli4 = _slicedToArray(_dataStr$split$0$spli3, 3),
      dia = _dataStr$split$0$spli4[0],
      mes = _dataStr$split$0$spli4[1],
      ano = _dataStr$split$0$spli4[2];
